...
<nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top text-white">
    <div class="container">
        <div class="navbar-wrapper">
            <a class="navbar-brand" href="/">Watch Over Me</a>
        </div>
    </div>
</nav>
<!-- End Navbar -->
<div class="wrapper wrapper-full-page">
    <div class="page-header error-page header-filter" style="background: linear-gradient( to left top, #595386, #4975aa, #4e9fd1);">
        ...
        <div class="content-center">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <h4>Requested link is invalid or expired.</h4>
                </div>
            </div>
        </div>
    </div>
