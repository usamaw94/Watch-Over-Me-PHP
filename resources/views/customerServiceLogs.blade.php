                    ...
                    <div class="col-md-4 col-sm-6">
                        <div class="card">
                            <div class="card-header card-header-primary">
                                <a href="/crServiceLogHistory/{{ $serviceDetails->service_id }}/all/all" style="float: right" class="btn btn-sm btn-secondary" title="Show logs history">Show history</a>
...
@section('script')
    ...
    <script src="/userAssets/js/customerServiceLogs.js"></script>
