    ...
    var chain = this.each(function() {
      ...
      if ($this.is('select')) {
        ...
        if (!data) {
          ...
          config.template = $.extend({}, Selectpicker.DEFAULTS.template, ($.fn.selectpicker.defaults ? $.fn.selectpicker.defaults.dashboard : {}), dataAttributes.dashboard, options.dashboard);
