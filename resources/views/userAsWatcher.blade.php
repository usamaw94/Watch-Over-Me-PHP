        ...
        <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
            <div class="container-fluid">
                <div class="navbar-wrapper">
                    ...
                    <a class="navbar-brand" href="javascript:;">User as Watcher</a>
                </div>
                                        ...
                                        <table class="table table-hover">
                                            ...
                                            @foreach($serviceAsWatcher as $sawt)
                                                <tr>
                                                    ...
                                                    <td data-id="{{ $sawt->wearerId }}" data-type="wearer" class="person-details-link person-details-modal">
                                                        {{ $sawt->wearerFullName }} &nbsp; <i class="fa fa-spinner fa-spin sr-only"></i>
                                                    </td>
                                                    <td data-id="{{ $sawt->customerId }}" data-type="customer" class="person-details-link person-details-modal">
...
@section('script')
    ...
    <script src="/userAssets/js/userAsWatcher.js"></script>
