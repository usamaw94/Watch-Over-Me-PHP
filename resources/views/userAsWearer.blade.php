        ...
        <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
            <div class="container-fluid">
                <div class="navbar-wrapper">
                    ...
                    <a class="navbar-brand" href="javascript:;">User as Wearer</a>
                </div>
                        ...
                        <div class="col-12">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <a href="/wrServiceLogs/?id={{$serviceDetails->service_id}}" class="btn btn-outline-info">
                            ...
                            <div class="card-header">
                                <div class="card-text">
                                    <h4 class="card-title text-danger">
                                        <i class="fa fa-info"></i> &nbsp;
                                        User is not a registered as a wearer in any service</h4>
                                </div>
                            </div>
...
@section('script')
    ...
    <script src="/userAssets/js/userAsWearer.js"></script>
