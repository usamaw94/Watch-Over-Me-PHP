...
<div>
    <h2 class="text-dark-blue left-space">
        <strong>Dear {{  $userFullName }},</strong></h2>
    <h4 class="left-space">Please verify your email address to use <b>Watch Over Me</b> services.</h4>
    <br>
    <a href="{{ $verificationLink }}" class="verify-link">Verfiy Email</a>
    <center>
