$(document).ready(function () {
    ...
    $(document).on("click",'.show-alert-log-details', function(event) {
        ...
        element.find(".alert-log-Info-Icon").addClass("sr-only");
        element.find(".alert-log-spinner").removeClass("sr-only");

        var id = $(this).attr('data-id');
        var wearerName = $(this).attr('data-wearer-name');


        var url="/alertLogDetails/";
        ...
        $.ajax({
            ...
            complete: function () {
                ...
                element.find(".alert-log-Info-Icon").removeClass("sr-only");
                element.find(".alert-log-spinner").addClass("sr-only");
            }
        });
    ...
    $(document).on("submit", "#logFiltersForm", function (e) {
        ...
        var url="/wrServiceLogHistory/"+serviceId+"/"+date+"/"+logType;
